  ...
  return (
    <div className='md:flex-[2_2_0] w-18 max-w-52'>
      <div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full'>
        ...
        {isLoading ? (
          // Show a loading spinner in place of the profile section while loading
          <div className='mt-auto mb-10 flex justify-center items-center'>
            <LoadingSpinner size='lg' />
          </div>
        ) : authUser && (
          // Show the user profile section once the data is loaded
          <Link
            href={`/profile/${authUser.username}`}
          ...
          >
            <div className='avatar hidden md:inline-flex'>
              <div className='w-8 rounded-full'>
                <Image src={authUser?.profileImg || "/avatar-placeholder.png"} alt="profileImage" width={32} height={32} />
              </div>
            </div>
